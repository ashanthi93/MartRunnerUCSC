...
<html lang="en">
    <head>
        ...
        <title>Confirm Vendor Attendance Thursday  | MartRunner</title>
    ...
    <body>
        ...
        <jsp:include page="/LoadAttendingVendorsThursday" />
        ...
        <section>
                        ...
                        <div class="panel panel-default">                            
                            ...
                            <div class="panel-body">    
                                ...
                                <div class="panel panel-default col-xs-6 col-md-6 col-md-6 col-lg-6">
                                    ...
                                    <form class="form-horizontal"  method="POST" name="attendVendorForm" onsubmit="return(validateSelection1())" action="${pageContext.request.contextPath}/ThursdayAttendanceRemove">
                                ...
                                <div class="panel panel-default col-xs-5 col-md-5 col-md-5 col-lg-5 col-xs-offset-1">
                                    ...
                                    <form class="form-horizontal" name="nAttendVendorForm"  method="POST" onsubmit="return(validateSelection2())" action="${pageContext.request.contextPath}/ThursdayAttendanceConfirmation">
                                ...
                                <div class="row">
                                    <div class="panel panel-default col-lg-10 col-md-10 col-sm-10 col-xs-10 col-xs-offset-1">
                                        ...
                                        <form class="form-horizontal"  method="POST" name="newVendorForm" onsubmit="return(validateSelection3())" action="${pageContext.request.contextPath}/AddNewAttendanceThursday">
            ...
            <!-- End of Thursday Attendance content-->
