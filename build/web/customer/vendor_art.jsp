...
<html>
    <head>
        ...
        <title> Art & Handicraft Vendors | MartRunner</title>
    ...
    <body id="vendors">
        ...
        <jsp:include page="/searchVendorArt" />
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-xs-10 col-xs-offset-2 col-sm-6 col-sm-offset-3  col-md-5 col-md-offset-1  col-lg-5 col-lg-offset-1">
                                ...
                                <div class="travelheader" style="font-size: 40px">
                                    <center> <p style="font-size:35px"> Good Market Art & Handicrafts Vendors </p></center>
                                </div>
                                ...
                                <div class="row">
                                    <div class="panel col-lg-11 col-md-11 col-sm-11" >
                                        <center><p style="font-size:16px">Art & Handicraft vendors of Good Market provide you arts and handicrafts which are made with natural things to keep you and your home more close to nature.</p></center>
                                    </div>
                                </div>
                                <!-- end of description-->
                                <br><br>
                                    ...
                                    <div id="myCarousel" class="carousel slide">
                                        ...
                                        <div class="carousel-inner" >
                                            <div class="item active"> 
                                                <img class="carouselimage" src="../static/images/art/1.jpg">
                                            </div>

                                            <div class="item"> 
                                                <img class="carouselimage" src="../static/images/art/2.jpg"> 
                                            </div>

                                            <div class="item">
                                                <img class="carouselimage" src="../static/images/art/3.jpg">
                                            </div>

                                            <div class="item"> 
                                                <img class="carouselimage" src="../static/images/art/4.jpg"> 
                                            </div>

                                            <div class="item">
                                                <img class="carouselimage" src="../static/images/art/5.jpg">                                            </div>

                                            <div class="item"> 
                                                <img class="carouselimage" src="../static/images/art/6.jpg">                                                
                                            </div>

                                            <div class="item"> 
                                                <img class="carouselimage" src="../static/images/art/7.jpg">                                                
                                            </div>
                                            <!-- Carousel nav --> 
