...
<html>
    <head>
        ...
        <title> Prepared Foods Vendors | MartRunner</title>
    ...
    <body id="vendors">
        ...
        <jsp:include page="/searchVendorPrepared" />
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-xs-10 col-xs-offset-2 col-sm-6 col-sm-offset-3  col-md-5 col-md-offset-1  col-lg-5 col-lg-offset-1">
                                ...
                                <div class="travelheader" style="font-size: 40px">
                                    <center> <p style="font-size:35px"> Good Market Prepared Food Vendors </p></center>
                                </div>
                                ...
                                <div class="row">
                                    <div class="panel col-lg-11 col-md-11 col-sm-11" >
                                        <center><p style="font-size:16px">Prepared Food vendors of Good Market provide you all kinds of prepared foods as rice & curry,juices,wrappers,burgers,sandwiches and cakes which are made with organically grown ingredients to keep your life more healthy.</p></center>
                                    </div>
                                </div>
                                <!-- end of description-->
                                <br><br>
                                    ...
                                    <div id="myCarousel" class="carousel slide">
                                        ...
                                        <div class="carousel-inner" >
                                            <div class="item active"> 
                                                <img class="carouselimage" src="../static/images/prepared/1.jpg">
                                            </div>

                                            <div class="item"> 
                                                <img class="carouselimage" src="../static/images/prepared/2.jpg"> 
                                            </div>

                                            <div class="item">
                                                <img class="carouselimage" src="../static/images/prepared/3.jpg">
                                            </div>

                                            <div class="item"> 
                                                <img class="carouselimage" src="../static/images/prepared/4.jpg"> 
                                            </div>

                                            <div class="item">
                                                <img class="carouselimage" src="../static/images/prepared/5.jpg">                                            </div>

                                            <div class="item"> 
                                                <img class="carouselimage" src="../static/images/prepared/6.jpg">                                                
                                            </div>

                                            <div class="item"> 
                                                <img class="carouselimage" src="../static/images/prepared/7.jpg">                                                
                                            </div>
                                            <!-- Carousel nav --> 
