...
<html>
    <head>
        ...
        <title> VisitThursday Good Market | MartRunner</title>
    ...
    <body id="vendors">
        ...
        <jsp:include page="/VisitThursday_Vendor" />
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-xs-10 col-xs-offset-2 col-sm-6 col-sm-offset-3  col-md-5 col-md-offset-1  col-lg-5 col-lg-offset-1">
                                ...
                                <div class="travelheader" style="font-size: 40px">
                                    <center> <p style="font-size:35px"><marquee direction="left"> Welcome to Thursday Good Market</marquee> </p></center>
                                </div>


                                <p>&nbsp;<b style="color: #006400">Location</b>:<strong style="color: #009900"> waters Edge</strong></p>
                                <p>&nbsp;<b style="color: #006400">Venue</b>: Thursday from <b style="color: #009900">10 AM to 6 PM</b>(rain or shine)</p>
    ...
    <!--___________________________________________________________________________________________________________________________________________-->
                                ...
                                <div class="panel col-lg-6 col-md-6 col-sm-6" >
                                    <div  style="font-size: medium;">
                                        <ul>
                                        <%
                                            List<Vendor> SearchResults = (List<Vendor>) session.getAttribute("thu");
                                            int looplengthLeft;
                                            int looplengthRight;
    ...
    <!--______________________________________________________________________________________________________________________________________-->
                                    <!--Vendor List of Other Thursday vendors-->        
                                    <div class="travelheader" >
                                        <p style="font-size:25px; color: #000"> Other Vendors on Thursday Good Market</p>
                                    </div>
                                    <div class="panel col-lg-6 col-md-6 col-sm-6" >
                                        <div  style="font-size: medium;">
                                            <ul>
                                            <%
                                                List<Vendor> SearchResults1 = (List<Vendor>) session.getAttribute("remainThu");
                                                int looplengthLeft1;
    ...
    <!--______________________________________________________________________________________________________________________________________________-->
                                    ...
                                    <div class="panel col-lg-12 col-md-12 col-sm-12" >
                                        <div class="panel col-lg-6 col-md-6 col-sm-6" ><a href="thursdayStallAssignment.jsp"><i class="fa fa-map-marker fa-3x"></i><b>stall map</b></a></div>
    ...
    <!--_____________________________________________________________________________________________________________________________________________-->
                            ...
                            <!--If day is Friday or Thursday show promotional image-->
                            <% if (dayOfweek == 5 || dayOfweek == 4 || dayOfweek == 2) { %>
