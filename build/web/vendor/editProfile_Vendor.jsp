...
<html>
    ...
    <body>
        ...
        <jsp:include page="/BasicProfileDetails" />
        ...
        <section>
            <div class="container" >
                <div class="row">
                    ...
                    <!-- Start of Edit Vendor Profile Form-->
                    <div class="container">
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9" >
                            <div class="panel panel-default" style="margin-top: 10px;">
                                ...
                                <!--Form Body-->
                                <div class="panel-body">
                                    <form class="form-horizontal" id="changevendorprofile" method="POST" action="${pageContext.request.contextPath}/editProfileVendor" role="form" onsubmit="return(checkChange())" novalidate>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <!--First name-->
                                                <label for="firstname" class="col-xs-5  col-sm-offset-0 col-sm-3 col-md-3 col-lg-3 control-label" style="display: inline-block; text-align: left">Change First Name</label>
                                                ...
                                                <!--Last name-->
                                                <label for="lastname" class="col-xs-5  col-sm-offset-0 col-sm-3 col-md-3 col-lg-3 control-label" style="display: inline-block; text-align: left">Change Last Name &nbsp;</label>
                                                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <!--NIC-->
                                                <label for="nic" class="col-xs-5 col-sm-offset-0 col-sm-3 col-md-3 col-lg-3 control-label" style="display: inline-block; text-align: left">Change NIC Number</label>
                                                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                                                    <input type="text" class="form-control" id="nicNumber" name="nicNumber" placeholder="<%=vendor.getUserNIC()%>" value="<%=vendor.getUserNIC()%>" onchange="markChange()" maxlength="10" />
                                        ...
                                        <div class="row">
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <!--Mobile Number-->
                                                <label for="mobile" class="col-xs-5 col-sm-offset-0 col-sm-3 col-md-3 col-lg-3 control-label" style="display: inline-block; text-align: left">Change Mobile Number</label>
                                                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                                                    <input type="tel" class="form-control" id="mobileNumber" name="mobileNumber" placeholder="<%=vendor.getUserContactNo()%>" value="<%=vendor.getUserContactNo()%>" onchange="markChange()" />
                                                    <label id="errorMobileNumber" style="font-size:10px"> </label>
                                                </div>

                                                <!--landphone-->
                                                <label for="landphone" class="col-xs-5 col-sm-offset-0 col-sm-3 col-md-3 col-lg-3 control-label" style="display: inline-block; text-align: left">Change Fixed Line &nbsp; &nbsp; &nbsp; &nbsp;</label>
                                                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                                                    <input type="text" class="form-control" id="fixedLine" name="fixedLine" placeholder="<%=vendor.getFixedLine()%>" value="<%=vendor.getFixedLine()%>" onchange="markChange()" />
                                        ...
                                        <div class="row">
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <!--Email Address-->
                                                <label for="email" class="col-xs-5  col-sm-offset-0 col-sm-3 col-md-3 col-lg-3 control-label" style="display: inline-block; text-align: left">Change Email Address &nbsp;</label>
                                                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                                    ...
                                                    <label for="fbID" class="visible-xs col-xs-6 col-xs-offset-0" style="display: inline-block; text-align: left"> Facebook Link </label>
                                                ...
                                                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                                    ...
                                                    <label for="gPlusD" class="visible-xs col-xs-6 col-xs-offset-0" style="display: inline-block; text-align: left"> Google Plus Link </label>
                                                    <div class="col-lg-12 col-lg-offset-6 col-md-12 col-sm-12 col-xs-6 col-xs-offset-0">
                                                ...
                                                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                                    ...
                                                    <label for="tweeterID" class="visible-xs col-xs-6 col-xs-offset-0" style="display: inline-block; text-align: left"> Tweeter Link </label>
                                                    <div class="col-lg-12 col-lg-offset-6 col-md-12 col-sm-12 col-xs-6 col-xs-offset-0">
                                        ...
                                        <div class="row">
                                            ...
                                            <center>
                                                ...
                                                <div class="col-xs-2 col-xs-offset-2 col-sm-offset-0 col-sm-2 col-md-2 col-lg-2 ">
                                                    <button type="button" class="btn btn-default" onclick="window.location.reload()"> <strong>Cancel</strong></button>
                                                </div>
                                            </center>
                                        </div>
                                    </form>
                    ...
                    <!-- End of Edit Vendor Profile Form-->
                </div>
            </div>
            ...
            function checkChange() {
                if (changes.length == 0) {
                    ...
                    if (prvPassword == "" & newPassword == "" & cnfrmPassword == "") {
                        document.getElementById("errorHead").innerHTML = "Empty Submissiom";
                    ...
                    var fixed = document.getElementById("fixedLine").value;
                    if (!validatePhoneNumber(fixed)) {
                        errorsEdit.push(1);
                    }
