    ...
    <body>
        ...
        <%
            ...
            if (session.getAttribute("User") == null) {
                ...
                if (privilage != 2) {            //user logout if unauthorized user change url path and try to log
            ...
            /*if (username == null) {
                ...
                out.println("</script>");
            }else if (privilage != 2){                  //error message if unauthorized user change url path and try to log
                out.println("<script type=\"text/javascript\">");
        ...
        <div class="container col-lg-12 col-md-12 col-sm-12 col-xs-12" id="subHeader">
            <div class="col-lg-1 col-md-1 col-lg-sm-1 col-xs-1">
                <a href="vendorHomePage.jsp" data-toggle="tooltip" title="Dashboard"> <button type="button" class="btn-default fa fa-tachometer" style="border-style: hidden; font-size:45px; color: #009900; background-color: black;"> </button> </a>
            </div>
