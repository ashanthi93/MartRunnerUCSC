...
<html>
    ...
    <head>
        ...
        <title>View Thursday Satll Assignment | MartRunner</title>
        ...
        <section>
            <div class="container" >
                <div class="row">
                            ...
                            <div class="panel-body">
                                <div  style="width:auto; height:auto;background-color:#71C671; border-radius:5px; margin-top:0px;"> 
                                    ...
                                    <center> 
                                        ...
                                        <a class="btn btn-default active" style="width:auto;" href="viewThursdayStallMap.jsp"> <strong> Thursday <br/> Stall Assignment </strong></a>
                                        ...
                                        <a class="btn btn-default" style="width:auto;" href="viewSaturdayStallMap.jsp"> <strong> Saturday <br/> Stall Assignment </strong></a>
                    ...
                    <!-- Start of View Stall Assignment Panel-->
                    <div class="container">
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9" >
                            <div class="panel panel-default" style="margin-top: 10px;">
                                ...
                                <div class="panel-heading" style="background-color: #71C671;">
                                    <p class="panel-title" style="color:#000; font-weight:bold; font-size: 20px;"> Thursday Stall Assignment </p>
                                </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div STYLE=" height:400px; width:auto; overflow: auto;">
                                        <img src="../static/images/ThursdayStallAssigment/out.jpg" style="height: auto; width: auto;">
                                    </div>
                                </div>
                            </div>
                        </div>
