...
public class UploadPromotionalPostservlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (ServletFileUpload.isMultipartContent(request)) {
                ...
                ImageIO.write(image, "jpg", new File("D:\\MartRunner\\web\\static\\images\\PromotionalPost\\out.jpg"));
                ...
                if (image != null) {
                    ...
                    session.setAttribute("successMsg", "Image upload successfully!");
                    ...
                    response.sendRedirect("admin/posts_Admin.jsp");
                }
