...
public class UploadSaturdayStallAssigmentSevlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (ServletFileUpload.isMultipartContent(request)) {
                ...
                ImageIO.write(image, "jpg", new File("D:\\MartRunner\\web\\static\\images\\SaturdayStallAssigment\\out.jpg"));
