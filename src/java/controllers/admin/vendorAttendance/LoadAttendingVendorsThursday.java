...
public class LoadAttendingVendorsThursday extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            paidVendorList = admin.loadVendorsAttendingThursday();
            ...
            if (paidVendorList.size() > 0) {
                ...
                List<Vendor> remainVendorList = admin.loadRemainVendors("TH", paidVendorListID);
