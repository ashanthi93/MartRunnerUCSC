...
public class HandleBlackListVendor2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            blackListVendor = (BlacklistVendors) session.getAttribute("BlackListVendor");           //set vendorID of selected blacklist vendor
            ...
            if(btnAction.equals("undoBlackList")){                              //following code will execute if btn action is undo blacklist 
            ...
            }else if(btnAction.equals("hidden")){
                
                boolean change = admin.changeToHiddenVendor(blackListVendor);
                
                if(change){                     //success message if vendor moved to hidden list
                ...
                }else{                          //error message if vendor moved to hidden list
            ...
            }else{                                          //redirect to remove vendor profile page if btn action is cancel
