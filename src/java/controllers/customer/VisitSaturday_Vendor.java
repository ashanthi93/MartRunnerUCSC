...
public class VisitSaturday_Vendor extends HttpServlet {
    
    Customer customer = new Customer();
    List resultList,AttendingSat,remainVendorList;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            resultList = customer.getSaturdayVendorList();
            AttendingSat = customer.loadVendorsAttendingSaturday();
            ...
            if (!AttendingSat.isEmpty()) {
                session.setAttribute("sat", AttendingSat);
                
                response.sendRedirect("customer/visitSaturday.jsp");
            } else {
            ...
            if (paidVendorList.size() > 0) {
                ...
                remainVendorList = customer.loadRemainVendors("SA", paidVendorListID);
                
                if (!remainVendorList.isEmpty()) {
                session.setAttribute("remainSat", remainVendorList);
