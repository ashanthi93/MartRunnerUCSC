...
public class searchVendorArt extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //method to get art n handicraft vendors
            answer = admin.searchByProductCategory("AH");
            ...
            out.println("<script type=\"text/javascript\">");
            out.println("alert('Search fails!');");
            out.println("location='../index.jsp';");
            out.println("</script>");
        }
    }
