...
public class ConfirmAttendanceSaturday extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int i = vendor.confirmAttendance("SA", status);
            ...
            if (i == 1) {
                ...
                response.sendRedirect("vendor/ConfirmSaturdayVendorAttendence.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ConfirmAttendanceSaturday.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
