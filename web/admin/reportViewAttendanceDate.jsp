...
<html>
    <head>
        ...
        <title> View Attendance Date | MartRunner</title>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9" >
                            <div class="panel panel-default" style="margin-top: 10px;">
                                ...
                                <div class="panel-heading" style="background-color: #71C671;">
                                    <p class="panel-title" style="color: black; font-weight: bold; padding-left: 5px; font-family: lucida bright;"> View Attendance for a Date </p>
                                </div>
                                <!--Form Body-->
                                <div class="panel-body">
                                    <form action="${pageContext.request.contextPath}/viewAttendanceOfADay" class="form-horizontal" id="changevendorprofile" method="POST"  role="form" onsubmit="return(validateForm())" novalidate>
                                        <br>
                                        <div class="row">
