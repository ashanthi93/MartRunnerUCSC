            ...
            <div class="container" >
                <div class="row col-xs-12 col-sm-12 col-sm-12 col-lg-12 ">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9" >
                        <div class="panel panel-default" style="margin-top: 10px;">
                            ...
                            <!--Form Body-->
                            <div class="panel-body">
                                <form action="${pageContext.request.contextPath}/viewAttendanceDayOfVendor" class="form-horizontal" id="form1" method="POST"  role="form" onsubmit="return(validateForm2())" novalidate>

                                    <!--Vendor name-->
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="vendorname" class="control-label col-xs-4 col-sm-5 col-md-4 col-md-offset-1 col-lg-3  required" style="display: inline-block; text-align: left;">Vendor Name</label>
                                            <div class="col-xs-5" style="margin-left: -20px;">
                                                <select class="combobox form-control" name="vendorName2" id="vendorName2" required>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-9 col-md-9 col-sm-9">
                                            <!-- Market Type-->
                                            <label for="marketType" class="control-label col-xs-4 col-sm-5 col-md-4 col-md-offset-1 col-lg-4  required" style="display: inline-block; text-align: left;"> Select Market Day </label>
                                            <div class="col-xs-4">


                                                <span>
                                                    <label style="font-weight: normal;"> <input type="radio" name="marketDay2" id="marketDay2" value="SA" /> Saturday Market</label> <br/>
                                                    <label style="font-weight: normal;"> <input type="radio" name="marketDay2" id="marketDay2" value="TH"/> Thursday Market</label> <br/>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-9 col-md-9 col-sm-9">
                                            <label  class="control-label col-xs-4 col-sm-5 col-md-4 col-md-offset-1 col-lg-4 required" style="display: inline-block; text-align: left;"> Select Start Day </label>
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9" >
                    <div class="panel panel-default" style="margin-top: 10px;">
                        ...
                        <!--Form Body-->
                        <div class="panel-body">
                            <form action="${pageContext.request.contextPath}/test" class="form-horizontal" id="form1" method="POST"  role="form" onsubmit="return(validateForm3())" novalidate>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label for="vendorname" class="control-label col-xs-3 col-xs-offset-1  required" style="display: inline-block; text-align: left;">Vendor Name</label>
                                        <div class="col-xs-6">
                                            <select class="combobox form-control" name="vendorName3" id="vendorName3" required disabled="disabled">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-4 col-sm-3 col-md-3 col-lg-3">
                                            ...
                                            <span>
                                                <label style="font-weight: normal;"> <input type="radio" name="marketDay3" id="marketDay3" value="SA" disabled="disabled" /> Saturday Market</label> <br/>
                                                <label style="font-weight: normal;"> <input type="radio" name="marketDay3" id="marketDay3" value="TH" disabled="disabled"/> Thursday Market</label> <br/>
                                ...
                                <div class="row">
                                    <div class="form-group ">
                                        ...
                                        <div class="hero-unit col-xs-4 ">
                                            <input  type="text" class="form-control" placeholder="click to add a date"  name="startDate" id="startDate"disabled="disabled">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div class="hero-unit col-xs-4 ">
                                            <input  type="text" class="form-control" placeholder="click to add a date"  name="endDate" id="endDate"disabled="disabled">
                                        </div>
