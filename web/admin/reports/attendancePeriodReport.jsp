...
<html>
    <head>
        ...
        <title> Attendance Report For Time Period </title>
            ...
            <div class="container">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h3 style="text-align: center;"> (Attendance Report of Vendors from  <% out.println(startDate); %> to <% out.println(endDate);%>) </h3>
                            </div>
                        </div>
