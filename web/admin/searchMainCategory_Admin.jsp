    ...
    <body>
                            ...
                            <form action="${pageContext.request.contextPath}/searchVendorByMainCatg" method="POST" class="form-horizontal" onsubmit="return(validateSearch())">
                                ...
                                <div class="form-group col-xs-10">
                                    ...
                                    <ul style="list-style:none;">
                                        <li> <input type="radio" name="mainCatg" id="mainCatg" value="RP"/> Rural Producers </li>
                                        <li> <input type="radio" name="mainCatg" id="mainCatg" value="SE"/> Social Enterprise </li>
                                        <li> <input type="radio" name="mainCatg" id="mainCatg" value="RB"/> Responsible Business </li>
                                    </ul>
                                </div>
                            ...
                            <form action="${pageContext.request.contextPath}/searchVendorByProductCatg" method="POST" class="form-horizontal" onsubmit="return(validateSearch())">
                                ...
                                <div class="form-group col-xs-10">
                                    ...
                                    <ul style="list-style:none;">
                                        ...
                                        <li> <input type="radio" name="hiddenVendorName" value="Hidden" disabled="disabled" /> Service Providers </li>
                                    </ul>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <div class="col-xs-offset-3 col-xs-9">
                                            <button type="submit" class="btn btn-default" disabled="disabled"> Ok </button>
                                            <button type="submit" class="btn btn-default" onclick="window.location.reload()" disabled="disabled"> Cancel </button>
                                        </div>
                                    </div>
                                </div>
        ...
        <script type="text/javascript">
            function validateSearch() {
                var mainCatg = document.getElementsByName("mainCatg");
                if (!(mainCatg[0].checked || mainCatg[1].checked || mainCatg[2].checked)) {
