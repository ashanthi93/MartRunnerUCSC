...
<html>
    <head>
        ...
        <title> Organic Standards | MartRunner </title>
            ...
            <div class="row container">
                <div class=" panel panel-default col-xs-10 col-xs-offset-2 col-lg-10 ">
                    <div class="panel-title header">
                        <center> <strong> Organic Products </strong> </center>
                    </div>
                    <br/>
                    <div class="panel-body">
                        <center>
                            ...
                            <h3 style="margin: 5px 300px 5px 300px">  All Natural </h3>
                            ...
                            <h3>Level 2 </h3>  
                            <hr class="hr-stand">                             
                            <h3 style="margin: 5px 300px 5px 300px">  All Natural and Free Range </h3>
