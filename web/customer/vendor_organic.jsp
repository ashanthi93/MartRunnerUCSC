...
<html>
    <head>
        ...
        <title> Organic Vendors | MartRunner</title>
    ...
    <body id="vendors">
        ...
        <jsp:include page="/searchVendorOrganic" />
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-xs-10 col-xs-offset-2 col-sm-6 col-sm-offset-3  col-md-5 col-md-offset-1  col-lg-5 col-lg-offset-1">
                                ...
                                <div class="travelheader" style="font-size: 40px">
                                    <center> <p style="font-size:35px"> Good Market Organic Product Vendors </p></center>
                                </div>
                                ...
                                <div class="row">
                                    <div class="panel col-lg-11 col-md-11 col-sm-11" >
                                        <center><p style="font-size:16px">Organic vendors of Good Market provide you vegetables,fruits which are organically grown for make your meals more healthy and also fresh and clean spices to make your meal more favourable.</p></center>
                                    </div>
                                </div>
                                <!-- end of description-->
                                <br><br>
                                    ...
                                    <div id="myCarousel" class="carousel slide">
                                        ...
                                        <div class="carousel-inner" >
                                            <div class="item active"> 
                                                <img class="carouselimage" src="../static/images/organic/1.jpeg">
                                            </div>

                                            <div class="item"> 
                                                <img class="carouselimage" src="../static/images/organic/2.jpg"> 
                                            </div>

                                            <div class="item">
                                                <img class="carouselimage" src="../static/images/organic/3.jpg">
                                            </div>

                                            <div class="item"> 
                                                <img class="carouselimage" src="../static/images/organic/4.jpg"> 
                                            </div>

                                            <div class="item">
                                                <img class="carouselimage" src="../static/images/organic/5.jpg">                                            </div>

                                            <div class="item"> 
                                                <img class="carouselimage" src="../static/images/organic/6.jpg">                                                
                                            </div>

                                            <div class="item"> 
                                                <img class="carouselimage" src="../static/images/organic/7.jpg">                                                
                                            </div>
                                            <!-- Carousel nav --> 
