...
<html>
    <head>
        ...
        <title> Confirm Thursday Vendor Attendance | Vendor </title>
    ...
    <body>
        ...
        <%            String confirmation = (String) session.getAttribute("AttendanceT");
                        ...
                        <div class="panel-body">
                            <center>
                                ...
                                <div style="width:auto; height:auto; background-color:#71C671; margin-top:10px;"> 
                                    ...
                                    <!-- Confirm Thursday Attendance icon-->
                                    ...
                                    <br/><br/>
                                    <a class="btn btn-default active" style="width:auto" href="ConfirmThursdayVendorAttendense.jsp">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9">
                        ...
                        <div class="panel panel-default">                            
                            ...
                            <div class="panel-title" style="font-size:16px; font-weight:bold; color:#218868; background-color: #C1FFC1; padding: 5px;"> 
                                <strong> Confirm Thursday Attendance </strong> 
                            </div>

                            <div class="panel-body">    

                                <form class="form-horizontal"  method="POST" onsubmit="return(validate_Attendace(<%=confirmation%>))" action="${pageContext.request.contextPath}/ConfirmAttendanceThursday">
                                        ...
                                        <div class="col-xs-6">
                                            <select class="form-control" id="Confirmation" name="Confirmation" >
                                                <% if ("1".equals(confirmation)) {
                                                        ...
                                                        out.println("<option value='0' > Not-Attending </option>");
